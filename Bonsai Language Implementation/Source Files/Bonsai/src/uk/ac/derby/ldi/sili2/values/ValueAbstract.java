...
public abstract class ValueAbstract implements Value {
	...
	public abstract Value ceil();
	public abstract Value floor();
	public abstract Value abs();
	public abstract Value factorial();
	public abstract Value power(Value v);
	public abstract Value sine();
	public abstract Value cosine();
	public abstract Value tangent();
	public abstract Value degrees();
	public abstract Value radians();
	public abstract Value pi();
